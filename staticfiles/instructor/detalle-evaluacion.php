    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box-detalle-evaluacion">
                <h3 class="font-family-Inter-SemiBold">Detalles de Nombre de Evaluación</h3>
                <h5 class="font-family-Inter-Medium">Curso Diseño Digital</h5>
                <div class="d-flex align-items-center justify-content-start" style="gap: 12px">
                    ...
                    <div class="">
                        <p class="mb-0 font-family-Inter-Medium">
                            Fram Davila
                            <span class="d-block font-family-Inter-Regular">Frdavi</span>
                        </p>
                    </div>
                </div>
                <div class="row mt-3 mb-3">
                    <div class="col-md-4">
                        <p class="mb-0 font-family-Inter-Regular">
                            Empezó: 01:20 PM - 05/02/2023
                        </p>
                    </div>
                    <div class="col-md-4">
                        <p class="mb-0 font-family-Inter-Regular">
                            Finalizó: 02:20 PM - 05/02/2023
                        </p>
                    </div>
                </div>
                <h2 class="font-family-Outfit-SemiBold">Nota: 40/50</h2>
            </div>
        </div>
        <div class="col-md-12">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td class="font-family-Inter-Medium texto-1">
                            1. ¿Para que sirve Adobe Photoshop ejemplo de pregunta?
                        </td>
                        <td class="font-family-Inter-Medium texto-1">
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-12 text-center">
            ...
            <img src="../img/logo-gris.png" alt="logo">
        </div>
    </div>
</div>
